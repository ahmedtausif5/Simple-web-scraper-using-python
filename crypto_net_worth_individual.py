...
def web_page():
    ...
    if float(ares_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(ares_dict["DOGE"]) + "</li> ")
    if float(ares_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(ares_dict["TEL"]) + "</li> ")
    if float(ares_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(ares_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
    ...
    if float(deepro_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(deepro_dict["DOGE"]) + "</li> ")
    if float(deepro_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(deepro_dict["TEL"]) + "</li> ")
    if float(deepro_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(deepro_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
    ...
    if float(niaz_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(niaz_dict["DOGE"]) + "</li> ")
    if float(niaz_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(niaz_dict["TEL"]) + "</li> ")
    if float(niaz_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(niaz_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
    ...
    if float(shourov_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(shourov_dict["DOGE"]) + "</li> ")
    if float(shourov_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(shourov_dict["TEL"]) + "</li> ")
    if float(shourov_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(shourov_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
    ...
    if float(sunny_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(sunny_dict["DOGE"]) + "</li> ")
    if float(sunny_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(sunny_dict["TEL"]) + "</li> ")
    if float(sunny_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(sunny_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
    ...
    if float(shuvo_dict["DOGE"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Doge:</strong> $""" +
                   str(shuvo_dict["DOGE"]) + "</li> ")
    if float(shuvo_dict["TEL"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Tel:</strong> $""" +
                   str(shuvo_dict["TEL"]) + "</li> ")
    if float(shuvo_dict["SHIB"]) > 0:
        file.write(""" <li class="list-group-item"><strong>Shib:</strong> $""" +
                   str(shuvo_dict["SHIB"]) + "</li> ")
    file.write("</ul>")
    file.write("<hr/>")
